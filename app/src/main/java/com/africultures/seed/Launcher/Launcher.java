package com.africultures.seed.Launcher;
...
import com.africultures.seed.Core.JasonModel;
...
import com.africultures.seed.BuildConfig;
import com.africultures.seed.Service.agent.JasonAgentService;
import com.africultures.seed.Service.websocket.JasonWebsocketService;
...
public class Launcher extends Application {
               ...
               String filename = fileList[i];
                ...
                try {
                    ...
                    if(jrjson.has("classname")){
                        String resolved_classname = "com.africultures.seed.Action." + jrjson.getString("classname");
    ...
    public void trigger(JSONObject intent_to_resolve, JasonViewActivity context) {
        try {
            ...
            if (type.equalsIgnoreCase("success")) {
                ...
                String primaryClassname = "com.africultures.seed.Action." + classname;
                String secondaryClassname = "com.africultures.seed.Core." + classname;
    ...
    public void callback(JSONObject handler, String result, JasonViewActivity context){
        try {
            String classname = handler.getString("class");
            classname = "com.africultures.seed.Action." + classname;
            String methodname = handler.getString("method");
