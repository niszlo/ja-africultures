package com.africultures.seed.Core;
...
import com.africultures.seed.Component.JasonComponentFactory;
import com.africultures.seed.Component.JasonImageComponent;
import com.africultures.seed.Helper.JasonHelper;
import com.africultures.seed.Launcher.Launcher;
import com.africultures.seed.Service.agent.JasonAgentService;
import com.africultures.seed.Service.vision.JasonVisionService;
import com.africultures.seed.Lib.JasonToolbar;
import com.africultures.seed.Lib.MaterialBadgeTextView;
import com.africultures.seed.R;
import com.africultures.seed.Section.ItemAdapter;
            ...
            if (type.startsWith("$") || type.startsWith("@")){
                ...
                if(tokens.length == 1){
                    ...
                    if(resolved_classname != null) {
                        fileName = "com.africultures.seed.Action." + resolved_classname;
                    } else {
                        fileName = "com.africultures.seed.Action.Jason" + className.toUpperCase().charAt(0) + className.substring(1) + "Action";
                    }
